...
function gaming_hub_tesla_vehicle_flow_assets() {
	...
	$labels = array(
		...
		'climate'    => __('Climate control', 'gaming-hub'),
	...
	// Host JA maps can lag behind theme strings; force Tesla flow card JA copy.
	if ( 'ja' === gaming_hub_lang() ) {
		$map = function_exists( 'gaming_hub_japanese_map' ) ? gaming_hub_japanese_map() : array();
