...
?>
<div class="pw-model3-unit" data-pw-model3-unit data-status="<?php echo esc_attr( (string) ( $model3['status_key'] ?? 'idle' ) ); ?>" aria-label="<?php esc_attr_e('Model 3 unit', 'gaming-hub'); ?>">
		...
		<div class="pw-model3-unit-identity">
			...
			<div class="pw-model3-badges">
				<span class="pw-model3-badge is-<?php echo esc_attr( (string) ( $model3['status_key'] ?? 'idle' ) ); ?>" data-pw-badge="status">
					<?php echo esc_html( $model3['badge_status'] ?? __('Standby', 'gaming-hub') ); ?>
				</span>
				<span
		...
		<div class="pw-model3-bars">
			<div class="pw-model3-bar">
				<div class="pw-model3-bar-meta">
					<span><?php esc_html_e('HP · battery', 'gaming-hub'); ?></span>
			...
			<div class="pw-model3-bar">
				<div class="pw-model3-bar-meta">
					<span><?php esc_html_e('MP · range', 'gaming-hub'); ?></span>
			...
			<div class="pw-model3-bar">
				<div class="pw-model3-bar-meta">
					<span><?php esc_html_e('Daily quest', 'gaming-hub'); ?></span>
				...
				<small data-pw-field="model3_quest_note"><?php esc_html_e('30 km / day', 'gaming-hub'); ?></small>
			</div>
		</div>
	</div>
	...
	>
		<p class="pw-model3-raid-title"><?php esc_html_e('Charge raid', 'gaming-hub'); ?></p>
	...
	<div class="pw-model3-career">
		<div>
			<span><?php esc_html_e('Odometer', 'gaming-hub'); ?></span>
			<strong data-pw-field="model3_odometer"><?php echo esc_html( $model3['odometer_plain_label'] ?? $model3['odometer_label'] ?? __('Odometer —', 'gaming-hub') ); ?></strong>
		</div>
		<div>
			<span><?php esc_html_e('Cabin temp', 'gaming-hub'); ?></span>
			<strong data-pw-field="model3_cabin_temp"><?php echo esc_html( $model3['cabin_temp_label'] ?? __('Cabin —', 'gaming-hub') ); ?></strong>
		</div>
		<div>
			<span><?php esc_html_e('Tire pressure', 'gaming-hub'); ?></span>
			<strong data-pw-field="model3_tire_pressure"><?php echo esc_html( $model3['tire_pressure_label'] ?? __('Tires —', 'gaming-hub') ); ?></strong>
		</div>
		<div>
			<span><?php esc_html_e('Firmware', 'gaming-hub'); ?></span>
			<strong data-pw-field="model3_patch"><?php echo esc_html( $model3['patch_label'] ?? __('Patch —', 'gaming-hub') ); ?></strong>
		</div>
		<div data-pw-next-raid <?php echo empty( $model3['next_raid_label'] ) ? ' hidden' : ''; ?>>
			<span><?php esc_html_e('Scheduled', 'gaming-hub'); ?></span>
