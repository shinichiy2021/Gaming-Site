...
<section
	...
	aria-label="<?php esc_attr_e('Driving log', 'gaming-hub'); ?>"
	data-tesla-gas
...
>
	<div class="ecoflow-plan-header ecoflow-plan-head">
		<div>
			...
			<h3><?php esc_html_e('Driving log', 'gaming-hub'); ?></h3>
			<p class="ecoflow-plan-note">
				<?php esc_html_e('Logs distance and energy use, then compares against a 15 km/L gas car for savings.', 'gaming-hub'); ?>
				<?php if ( $price_label ) : ?>
		...
		<p class="ecoflow-plan-limits">
			...
			<span class="ecoflow-cal-nav">
				<button type="button" class="ecoflow-plan-cancel" data-tesla-gas-prev data-month="<?php echo esc_attr( $calendar['prev'] ?? '' ); ?>"><?php esc_html_e('Prev month', 'gaming-hub'); ?></button>
				<button type="button" class="ecoflow-plan-cancel" data-tesla-gas-next data-month="<?php echo esc_attr( $calendar['next'] ?? '' ); ?>"><?php esc_html_e('Next month', 'gaming-hub'); ?></button>
			</span>
		</p>
	</div>
	...
	<div class="tesla-gas-summary" data-tesla-gas-summary>
		<div class="tesla-gas-summary-head">
			<div>
				...
				<strong data-tesla-gas-summary-label><?php echo esc_html( (string) ( $sum_view['label'] ?? __('Today', 'gaming-hub') ) ); ?></strong>
			</div>
			<div class="tesla-gas-summary-tabs" role="tablist" aria-label="<?php esc_attr_e('Daily / weekly summary', 'gaming-hub'); ?>">
				<button
					type="button"
				...
				><?php esc_html_e('Day', 'gaming-hub'); ?></button>
				<button
					type="button"
				...
				><?php esc_html_e('Week', 'gaming-hub'); ?></button>
			</div>
		</div>
		<?php
		...
		<?php if ( ! empty( $eff['badge_wh'] ) || ! empty( $eff['badge_regen'] ) ) : ?>
			<div class="tesla-eff-badges tesla-eff-badges-inline" aria-label="<?php esc_attr_e('Efficiency badges', 'gaming-hub'); ?>">
		...
		<div class="tesla-gas-summary-grid" role="tabpanel">
			<div class="tesla-gas-summary-stat">
				<span><?php esc_html_e('Driving', 'gaming-hub'); ?></span>
				<strong data-tesla-gas-summary-km><?php echo esc_html( $format_km( $sum_view['km'] ?? 0 ) ); ?></strong>
			</div>
			<div class="tesla-gas-summary-stat">
				<span><?php esc_html_e('Charge ¥', 'gaming-hub'); ?></span>
	...
	<div class="ecoflow-rates-hud ecoflow-plan-hud ecoflow-cal-hud">
		...
		<div class="ecoflow-rates-stat">
			<span><?php esc_html_e('Driven this month', 'gaming-hub'); ?></span>
		...
		<div class="ecoflow-rates-stat ecoflow-cal-stat-save">
			<span><?php esc_html_e('Saved this month', 'gaming-hub'); ?></span>
		...
		<div class="ecoflow-rates-stat">
			<span><?php esc_html_e('Gas avoided', 'gaming-hub'); ?></span>
	...
	<ol class="tesla-charge-list tesla-gas-list" data-tesla-gas-list>
		<?php if ( empty( $rows ) ) : ?>
			<li class="tesla-charge-empty" data-tesla-gas-empty>
				<?php esc_html_e('No driving log for this month yet.', 'gaming-hub'); ?>
			</li>
		<?php endif; ?>
		...
		<?php foreach ( $rows as $cell ) : ?>
			...
			<li class="tesla-charge-row<?php echo $is_today ? ' is-active' : ''; ?>" data-tesla-gas-day="<?php echo esc_attr( (string) ( $cell['date'] ?? '' ) ); ?>">
				<div class="tesla-charge-when">
					...
					<?php if ( $is_today ) : ?>
						<span class="tesla-charge-badge"><?php esc_html_e('Today', 'gaming-hub'); ?></span>
					<?php endif; ?>
				</div>
